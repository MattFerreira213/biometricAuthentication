...
class BiometricPromptManager(private val activity: AppCompatActivity) {
    ...
    fun showBiometricPrompt(tittle: String, description: String){
        ...
        when(manager.canAuthenticate(authenticators)){
            BiometricManager.BIOMETRIC_ERROR_HW_UNAVAILABLE -> {
                resultChannel.trySend(BiometricResult.HarwareUnavailable)
                return
            }
    ...
    sealed interface BiometricResult{
        data object HarwareUnavailable: BiometricResult
